...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Traduction pour la page anglais en francais
    |--------------------------------------------------------------------------
    |
    | plus d'info...
    |
...
'diffNIVEAUX'=> 'Consulter les différents niveaux de langue',
    'block15'=> 'Après un test de niveau qui dure 30 minutes, l\'apprenant  est admis à un des niveaux du programme, A1, A2, B1, B2, C1, C2.
Nous dispensons des cours d\'Anglais général pour tous les niveaux. Que vous soyez élève, étudiant, chercheur d\'emplois
ou même travailleurs les différents cours d\'Anglais que nous dispensons au Churchill Training Institute permettrons
d\'améliorer ou de perfectionner vos connaissances en anglais, vous donnant ainsi un atout supplémentaire pour votre
progrès professionnel ou académique.',
